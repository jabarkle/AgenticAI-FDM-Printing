...
def recon_node(state,model,name):
    ...
    IMPORTANT: To get temperatures, use query_printer with object names like "extruder" or "heater_bed". Do NOT use G-code commands like M105 for querying temperatures — they do not return data through this API.\n\
