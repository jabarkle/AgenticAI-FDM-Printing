...
while True:
    ...
    if printer_status == "paused":
        ...
        if current_layer ==0:
            ...
            image_top = get_image("172.26.197.215:81", f"./results/no_llm/top_layer_{1}.jpg", mode="top")
            image_front = get_image("172.26.197.215:81", f"./results/no_llm/front_layer_{1}.jpg")
        else:
            image_top = get_image("172.26.197.215:81", f"./results/no_llm/top_layer_{current_layer}.jpg", mode="top")
            image_front = get_image("172.26.197.215:81", f"./results/no_llm/front_layer_{current_layer}.jpg")
        print("Image saved.")
        time.sleep(1)
        resume_print(url)
